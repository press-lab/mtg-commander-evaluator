...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("is_commander_legal", sa.Boolean, nullable=False, server_default="true"),
    ...
    op.create_index("ix_spellbook_combo_cards_combo_id", "spellbook_combo_cards", ["combo_id"])
    op.create_index("ix_spellbook_combo_cards_oracle_id", "spellbook_combo_cards", ["oracle_id"])
    op.create_index("ix_spellbook_combos_bracket_tag", "spellbook_combos", ["bracket_tag"])
